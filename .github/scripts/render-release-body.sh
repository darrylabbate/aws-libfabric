...
#   RELEASE_VERSION              - AWS-specific release version (e.g., 2.4.0amzn1.0)
...
#   CURRENT_TAG                  - current AWS-specific release tag (e.g., v2.4.0amzn1.0)
...
cat <<EOF
This AWS-specific release is based on [${UPSTREAM_REPO}@${UPSTREAM_SHA}](${SERVER_URL}/${UPSTREAM_REPO}/commit/${UPSTREAM_SHA}).
EOF
